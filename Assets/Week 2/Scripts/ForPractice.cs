...
public class ForPractise : MonoBehaviour
{
    ...
    void BaiTap6()
    {
        ...
        for (int i = 0; i < listString.Count; i++)
        {
            if (listString[i].Length > lengthMax)
            {
                lengthMax = listString[i].Length;
                index = i;
            }
        }
    ...
    void BaiTap12()
    {
        ...
        {
            if (listString[i].Length < lengthMin)
            {
                lengthMin = listString[i].Length;
                index = i;
            }
        }
    ...
    void BaiTap14()
    {
        ...
        for (int i = 1; i < arr.Length; i++)
        {
            if (totalMax < (max + arr[i]) && (max + arr[i]) != (max * 2))
            {
                totalMax = max + arr[i];
                maxSecond = arr[i];
            }
    ...
    void BaiTap16()
    {
        ...
        for (int i = 0; i < listString.Count;i++) 
        {
            if (listString[i].ToLower().Contains(searchString.ToLower()))
            {
                Debug.Log(listString[i]);
                checkExist = true;
            }
